...
public class ScaleJoinTest {
	...
	static long event_dt = 10; // in milliseconds
	static long ws;
	static String inputRatePath = "";
	static String directory = "results";
	...
	public static void main(String[] args) throws Exception {
		...
		Operator<Tuple, ?, ElasticityControl> operator = new JoinOperator<>(ScaleJoinFunction.class,
				new ScaleJoinFunction<>(buckets, ws), exeConfig, controlObj);
